...
func init() {
	...
	md_OrderBook = File_bridge_dex_order_proto.Messages().ByName("OrderBook")
...
func (x *OrderBook) slowProtoReflect() protoreflect.Message {
	mi := &file_bridge_dex_order_proto_msgTypes[0]
...
func (x *fastReflection_OrderBook) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bridge.dex.OrderBook.idCount":
		return x.IdCount != int32(0)
	case "bridge.dex.OrderBook.orders":
		return len(x.Orders) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.OrderBook"))
		}
		panic(fmt.Errorf("message bridge.dex.OrderBook does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OrderBook) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bridge.dex.OrderBook does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OrderBook) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "bridge.dex.OrderBook.idCount":
		panic(fmt.Errorf("field idCount of message bridge.dex.OrderBook is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.OrderBook"))
		}
...
func (x *fastReflection_OrderBook) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bridge.dex.OrderBook", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_bridge_dex_order_proto_init()
	md_Order = File_bridge_dex_order_proto.Messages().ByName("Order")
...
func (x *Order) slowProtoReflect() protoreflect.Message {
	mi := &file_bridge_dex_order_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Order) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bridge.dex.Order.id":
		return x.Id != int32(0)
	case "bridge.dex.Order.creator":
		return x.Creator != ""
	case "bridge.dex.Order.amount":
		return x.Amount != int32(0)
	case "bridge.dex.Order.price":
		return x.Price != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.Order"))
		}
		panic(fmt.Errorf("message bridge.dex.Order does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Order) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bridge.dex.Order does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Order) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "bridge.dex.Order.id":
		panic(fmt.Errorf("field id of message bridge.dex.Order is not mutable"))
	case "bridge.dex.Order.creator":
		panic(fmt.Errorf("field creator of message bridge.dex.Order is not mutable"))
	case "bridge.dex.Order.amount":
		panic(fmt.Errorf("field amount of message bridge.dex.Order is not mutable"))
	case "bridge.dex.Order.price":
		panic(fmt.Errorf("field price of message bridge.dex.Order is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.Order"))
		}
...
func (x *fastReflection_Order) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bridge.dex.Order", d.FullName()))
	}
	panic("unreachable")
}
...
func (*OrderBook) Descriptor() ([]byte, []int) {
	return file_bridge_dex_order_proto_rawDescGZIP(), []int{0}
}
...
func (*Order) Descriptor() ([]byte, []int) {
	return file_bridge_dex_order_proto_rawDescGZIP(), []int{1}
}
...
var File_bridge_dex_order_proto protoreflect.FileDescriptor

var file_bridge_dex_order_proto_rawDesc = []byte{
	0x0a, 0x16, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2f, 0x64, 0x65, 0x78, 0x2f, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65,
	0x2e, 0x64, 0x65, 0x78, 0x22, 0x50, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x6f, 0x6f,
	0x6b, 0x12, 0x18, 0x0a, 0x07, 0x69, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x07, 0x69, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x06, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x62, 0x72,
	0x69, 0x64, 0x67, 0x65, 0x2e, 0x64, 0x65, 0x78, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x06,
	...
	,
}

var (
	file_bridge_dex_order_proto_rawDescOnce sync.Once
	file_bridge_dex_order_proto_rawDescData = file_bridge_dex_order_proto_rawDesc
)

func file_bridge_dex_order_proto_rawDescGZIP() []byte {
	file_bridge_dex_order_proto_rawDescOnce.Do(func() {
		file_bridge_dex_order_proto_rawDescData = protoimpl.X.CompressGZIP(file_bridge_dex_order_proto_rawDescData)
	})
	return file_bridge_dex_order_proto_rawDescData
}

var file_bridge_dex_order_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_bridge_dex_order_proto_goTypes = []interface{}{
	(*OrderBook)(nil), // 0: bridge.dex.OrderBook
	(*Order)(nil),     // 1: bridge.dex.Order
}
var file_bridge_dex_order_proto_depIdxs = []int32{
	1, // 0: bridge.dex.OrderBook.orders:type_name -> bridge.dex.Order
...
func init() { file_bridge_dex_order_proto_init() }
func file_bridge_dex_order_proto_init() {
	if File_bridge_dex_order_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bridge_dex_order_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bridge_dex_order_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bridge_dex_order_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bridge_dex_order_proto_goTypes,
		DependencyIndexes: file_bridge_dex_order_proto_depIdxs,
		MessageInfos:      file_bridge_dex_order_proto_msgTypes,
	}.Build()
	File_bridge_dex_order_proto = out.File
	file_bridge_dex_order_proto_rawDesc = nil
	file_bridge_dex_order_proto_goTypes = nil
	file_bridge_dex_order_proto_depIdxs = nil
}
