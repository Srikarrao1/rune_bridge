...
func init() {
	...
	md_SellOrder = File_bridge_dex_sell_order_proto.Messages().ByName("SellOrder")
...
func (x *SellOrder) slowProtoReflect() protoreflect.Message {
	mi := &file_bridge_dex_sell_order_proto_msgTypes[0]
...
func (x *fastReflection_SellOrder) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Index != "" {
		...
		if !f(fd_SellOrder_index, value) {
			return
		}
	}
	if x.AmountDenom != "" {
		value := protoreflect.ValueOfString(x.AmountDenom)
		if !f(fd_SellOrder_amountDenom, value) {
			return
		}
	}
	if x.PriceDenom != "" {
		value := protoreflect.ValueOfString(x.PriceDenom)
		if !f(fd_SellOrder_priceDenom, value) {
			return
		}
	}
}
...
func (x *fastReflection_SellOrder) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message bridge.dex.SellOrder does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SellOrder) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bridge.dex.SellOrder does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SellOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "bridge.dex.SellOrder.amountDenom":
		panic(fmt.Errorf("field amountDenom of message bridge.dex.SellOrder is not mutable"))
	case "bridge.dex.SellOrder.priceDenom":
		panic(fmt.Errorf("field priceDenom of message bridge.dex.SellOrder is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.SellOrder"))
		}
...
func (x *fastReflection_SellOrder) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bridge.dex.SellOrder", d.FullName()))
	}
	panic("unreachable")
}
...
func (*SellOrder) Descriptor() ([]byte, []int) {
	return file_bridge_dex_sell_order_proto_rawDescGZIP(), []int{0}
}

func (x *SellOrder) GetIndex() string {
	if x != nil {
		return x.Index
	}
	return ""
...
func (x *SellOrder) GetAmountDenom() string {
	if x != nil {
		return x.AmountDenom
	}
	return ""
...
func (x *SellOrder) GetPriceDenom() string {
	if x != nil {
		return x.PriceDenom
	}
	return ""
...
var (
	file_bridge_dex_sell_order_proto_rawDescOnce sync.Once
	file_bridge_dex_sell_order_proto_rawDescData = file_bridge_dex_sell_order_proto_rawDesc
)

func file_bridge_dex_sell_order_proto_rawDescGZIP() []byte {
	file_bridge_dex_sell_order_proto_rawDescOnce.Do(func() {
		file_bridge_dex_sell_order_proto_rawDescData = protoimpl.X.CompressGZIP(file_bridge_dex_sell_order_proto_rawDescData)
	})
	return file_bridge_dex_sell_order_proto_rawDescData
}
...
func file_bridge_dex_sell_order_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bridge_dex_sell_order_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bridge_dex_sell_order_proto_goTypes,
		DependencyIndexes: file_bridge_dex_sell_order_proto_depIdxs,
		MessageInfos:      file_bridge_dex_sell_order_proto_msgTypes,
	}.Build()
	File_bridge_dex_sell_order_proto = out.File
	file_bridge_dex_sell_order_proto_rawDesc = nil
	file_bridge_dex_sell_order_proto_goTypes = nil
	file_bridge_dex_sell_order_proto_depIdxs = nil
}
