...
var (
	...
	fd_SellPacketData_seller      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_SellPacketData_seller = md_SellPacketData.Fields().ByName("seller")
}
...
func (x *fastReflection_SellPacketData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Seller != "" {
		...
		if !f(fd_SellPacketData_seller, value) {
			return
		}
	}
}
...
func (x *fastReflection_SellPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "bridge.dex.SellPacketData.seller":
		return x.Seller != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_SellPacketData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "bridge.dex.SellPacketData.seller":
		panic(fmt.Errorf("field seller of message bridge.dex.SellPacketData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.SellPacketData"))
		}
...
var (
	...
	fd_BuyPacketData_buyer       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_BuyPacketData_buyer = md_BuyPacketData.Fields().ByName("buyer")
}
...
func (x *fastReflection_BuyPacketData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Buyer != "" {
		...
		if !f(fd_BuyPacketData_buyer, value) {
			return
		}
	}
}
...
func (x *fastReflection_BuyPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "bridge.dex.BuyPacketData.price":
		return x.Price != int32(0)
	case "bridge.dex.BuyPacketData.buyer":
		return x.Buyer != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BuyPacketData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "bridge.dex.BuyPacketData.buyer":
		panic(fmt.Errorf("field buyer of message bridge.dex.BuyPacketData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bridge.dex.BuyPacketData"))
		}
...
func (x *SellPacketData) GetSeller() string {
	if x != nil {
		return x.Seller
	}
	return ""
...
func (x *BuyPacketData) GetBuyer() string {
	if x != nil {
		return x.Buyer
	}
	return ""
...
var file_bridge_dex_packet_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x41, 0x63, 0x6b, 0x22, 0x98, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x6c, 0x6c, 0x50, 0x61,
	...
	0x05, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x6c, 0x6c,
	0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x72,
	0x22, 0x4d, 0x0a, 0x0d, 0x53, 0x65, 0x6c, 0x6c, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63,
	...
	0x69, 0x6e, 0x69, 0x6e, 0x67, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x67,
	0x61, 0x69, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x67, 0x61, 0x69, 0x6e, 0x22,
	0x95, 0x01, 0x0a, 0x0d, 0x42, 0x75, 0x79, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x44, 0x61, 0x74,
	0x61, 0x12, 0x20, 0x0a, 0x0b, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x65, 0x6e, 0x6f, 0x6d,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x65,
	...
	0x52, 0x05, 0x62, 0x75, 0x79, 0x65, 0x72, 0x22, 0x54, 0x0a, 0x0c, 0x42, 0x75, 0x79, 0x50, 0x61,
	...
	0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x42, 0x83, 0x01,
	0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2e, 0x64, 0x65, 0x78,
	...
	0x69, 0x2f, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2f, 0x64, 0x65, 0x78, 0xa2, 0x02, 0x03, 0x42,
	0x44, 0x58, 0xaa, 0x02, 0x0a, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2e, 0x44, 0x65, 0x78, 0xca,
	0x02, 0x0a, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x5c, 0x44, 0x65, 0x78, 0xe2, 0x02, 0x16, 0x42,
	0x72, 0x69, 0x64, 0x67, 0x65, 0x5c, 0x44, 0x65, 0x78, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0b, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x3a, 0x3a,
