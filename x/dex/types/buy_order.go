...
func (b *BuyOrder) FillSellOrder(order Order) (
...
func (b *BuyOrder) LiquidateFromSellOrder(order Order) (
    remainingSellOrder Order,
...
func (b *BuyOrder) AppendOrder(creator string, amount int32, price int32) (int32, error) {
